...
def Compute_event (event, t):
    ...
    if event == "mild_negative":
        event_state = generate_event(EVENT_SCENARIOS["mild_negative"], 0.07, t) #takes 30 Ts to fully recover 

    if event == "mild_positive":
        event_state = generate_event(EVENT_SCENARIOS["mild_positive"], 0.07, t)
